...
#         gradian = gradian_function(predict, w, x_vector)
...
# non_numeric_columns = ['City Rank', 'State Rank', 'Vin Rank', 'Make Rank', 'Model Rank']
# lr = Linear_Regression(x:df.loc[:,columns], target:df['Price'], columns:columns, learning_rate:0.05, epoch:1000, non_numeric_columns:non_numeric_columns)
...
# df = pd.read_csv('/content/drive/MyDrive/ML_HW2_Q1/train.csv').iloc[50000:50050, :]
